...
def entrada_microfone():
    ...
    try:
        with spch.Microphone() as micro:
            msg = QMessageBox.information(None, 'Aspide Recognizer',
                                          "O audio é começara a gravar apos o ok!", QMessageBox.Ok | QMessageBox.Cancel, QMessageBox.Ok)
            ...
            if msg == QMessageBox.Ok:
                ...
                msg2 = QMessageBox(None)
                msg2.setWindowTitle("Aspide Recognizer")
                msg2.setIcon(QMessageBox.Information)
                msg2.setText("Gravado com Sucesso!!")
                msg2.exec_()
...
def transc_file(path):
    ...
    with spch.AudioFile(path) as source:
        try:
            msg = QMessageBox.information(None, 'Aspide Recognizer', "Apos o ok começará a transcrição",
            ...
            if msg == QMessageBox.Ok:
                ...
                msg2.setWindowTitle("Aspide Recognizer")
                msg2.setIcon(QMessageBox.Information)
                msg2.setText("Transcrito com Sucesso!!")
                msg2.exec_()
                return transcrito
        except spch.UnknownValueError:
            ...
            msg2.setWindowTitle("Aspide Recognizer")
            msg2.setIcon(QMessageBox.Information)
            msg2.setText("Não foi possivel trancrever o arquivo!!")
            msg2.exec_()
